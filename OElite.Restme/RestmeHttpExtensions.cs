    ...
    public static class RestmeHttpExtensions
    {
            ...
            string? relativePath = null)
        {
            ...
            if (restme.CurrentMode == RestMode.Http)
            {
                ...
                else if (restme.ObjAsParam != null)
                {
                    submitContent = new StringContent(restme.ObjAsParam.JsonSerialize());
            ...
            {
                if (restme.Params.Count > 0)
                    submitContent = new OEliteRestfulHttpContent(restme.Params);
                else if (restme.ObjAsParam != null)
                {
                    submitContent = new StringContent(restme.ObjAsParam.JsonSerialize());
                }
            ...
            if (restme.BaseUri == null)
                throw new InvalidEnumArgumentException(nameof(restme.BaseUri));
        ...
        public static async Task<T?> HttpRequestAsync<T>(this Rest restme, HttpMethod method,
            string? relativePath = null)
        {
